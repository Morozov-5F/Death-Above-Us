...
namespace devalpha.Objects
{
    public class Turret : ISprite
    {
        ...
        public void LoadContent(ContentManager contentManager)
        {
            ...
            basePosition *= 1.0f / Camera.GameScale;
            basePosition -= new Vector2(0, Texture.Height) * Scale;

            turretOffset = new Vector2(121f, 270f);
            baseOffset = new Vector2(207f, 0f);
            //turretRotation = (float)Math.PI / 4f;
        ...
        public void Update(GameTime time)
        {
            ...
            {
                //Debug.WriteLine(gesture.Delta.X.ToString() + " " + gesture.Position.X.ToString());
